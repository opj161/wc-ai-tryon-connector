...
if ( ! class_exists( 'WC_AI_TryOn_Settings' ) ) :
	...
	class WC_AI_TryOn_Settings extends WC_Integration {
		...
		public function __construct() {
			$this->id                 = 'wc_ai_tryon';
			$this->method_title       = __( 'AI Virtual Try-On', 'wc-ai-tryon' );
			$this->method_description = __( 'Configure the connection to your n8n workflow for AI image generation.', 'wc-ai-tryon' );
		...
		public function init_form_fields() {
			$this->form_fields = array(
				'section_connection' => array(
					'title' => __( 'n8n Connection', 'wc-ai-tryon' ),
					'type'  => 'title',
					'description' => __( 'Enter the details from your n8n Webhook node.', 'wc-ai-tryon' ),
				),
				'n8n_webhook_url' => array(
					'title'       => __( 'n8n Webhook URL', 'wc-ai-tryon' ),
					'type'        => 'text',
					'description' => __( 'The Production URL of your n8n Webhook (POST method).', 'wc-ai-tryon' ),
					'desc_tip'    => true,
					'default'     => '',
